...
ActiveRecord::Schema.define(version: 2021_01_17_093227) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["recruiting_id"], name: "index_comments_on_recruiting_id"
  ...
  create_table "notices", force: :cascade do |t|
    ...
    t.integer "recruiting_id"
    t.integer "reason_for_delete_entry", default: 0, null: false
  ...
  create_table "recruitings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "participants_numbers", default: 0
  end
